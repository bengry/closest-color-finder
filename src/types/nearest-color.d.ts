declare module 'nearest-color' {
  ...
  function nearestColor<
    TReturnValue extends ColorMatch | string = ColorMatch | string,
  >(needle: NeedleColor, colors?: readonly ColorSpec[]): TReturnValue | null;
   ...
   * ```
   */
  export const from: NearestColorFrom;

  interface NearestColorFrom {
    (availableColors: readonly string[]): typeof nearestColor<string>;
    (availableColors: {
      [colorName: string]: string;
    }): typeof nearestColor<ColorMatch>;
  }

  /**
   * A map from the names of standard CSS colors to their hex values.
   */
  export const STANDARD_COLORS: { [colorName: string]: string };
   ...
   */
  export const DEFAULT_COLORS: readonly ColorSpec[];
}
